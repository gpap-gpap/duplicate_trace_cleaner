...
st.session_state["sgy"] = st.file_uploader("First upload SEGY file (might not work with large files)", type=["sgy", "segy"])

if st.session_state["sgy"] is not None:
   n_traces, sample_rate, n_samples, twt, text_head, trace_head = write_data_to_session_state(st.session_state['sgy'])
